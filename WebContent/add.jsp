...
<body background="2.jpg" style="background-repeat:no-repeat;background-size:100%;">
	...
	<div style="text-align: center;">
		<%
			...
			{
		%>
		<input type="button" value="<%=empty.get(i)%>" style="width:40px;color:green;">
		<%
			j++;
				if(j%5==0)
				{
	...
	<hr color="grey">
	<form method="post" action="operate?method=add" onsubmit="return check()">
		<div style="text-align: center;">
			<table align="center" border="1" style="margin: auto；" width='30%'>
				<tr>
					<td>车牌号：</td>
					<td><input type="text" id="num" name="num" class="demo" onblur="if (!/^[\u4e00-\u9fa5]{1}[A-Z]{1}[A-Z_0-9]{5}$/.test(value)) value =''"></td>
				</tr>
				<tr>
					<td>停车位编号：</td>
				...
				<tr>
					<td colspan="2"><input type="submit" value="入库">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					</td>
				</tr>
			</table>
